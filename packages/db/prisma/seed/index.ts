...
// (Content data — questions/exams/schedules/stats — comes from content/ via the sync
// script, not this seed. See docs/03-content-pipeline.md. Local dev fixtures live in
// dev.ts, run via `db:seed:dev`.)
